...
function Team() {
  return (
    <>      
      {/* component */}
<div id="team" className="section relative pt-20 pb-8 md:pt-16 bg-white bg-gray-800">
    <div className="container xl:max-w-6xl mx-auto px-4">
        {/* section header */}
        <header className="text-center mx-auto mb-12">
            <h2 className="text-2xl leading-normal mb-2 font-bold dark:text-gray-800 text-gray-100">
                <span className="font-light">Our</span> Team
            </h2>
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60" style={{margin: "0 auto", height: 35}} xml:space="preserve">
        ...
        <div className="flex flex-wrap flex-row -mx-4 justify-center">
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                <div className="relative overflow-hidden bg-white bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" style={{visibility: "visible", animationDuration: "1s", animationName: "fadeInUp"}}>
                    {/* team block */}
                    ...
                    <div className="pt-6 text-center">
                        <p className="text-lg leading-normal font-bold mb-1">João Vicente</p>
                        <p className="text-gray-500 leading-relaxed font-light">Tech God</p>
                        {/* social icon */}
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                {/* team block */}
                <div className="relative overflow-hidden bg-white bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.3s", animationName: "fadeInUp"}}>
                    <div className="relative overflow-hidden px-6">
                    ...
                    <div className="pt-6 text-center">
                        <p className="text-lg leading-normal font-bold mb-1">Raúl Gomes</p>
                        <p className="text-gray-500 leading-relaxed font-light">Developer Wizard</p>
                        {/* social icon */}
                        <div className="mt-2 mb-5 space-x-2">
                            <a className="hover:text-blue-700" aria-label="Twitter link" href="/">
                                {/* <i className="fab fa-twitter text-twitter"></i> */}
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
                {/* team block */}
                <div className="relative overflow-hidden bg-white bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s" style={{visibility: "visible", animationDuration: "1s", animationDelay: "0.5s", animationName: "fadeInUp"}}>
                    <div className="relative overflow-hidden px-6">
                    ...
                    <div className="pt-6 text-center">
                        <p className="text-lg leading-normal font-bold mb-1">Leandro Santos</p>
                        <p className="text-gray-500 leading-relaxed font-light">Master Scripter</p>
                        {/* social icon */}
                        <div className="mt-2 mb-5 space-x-2">
                            <a className="hover:text-blue-700" aria-label="Twitter link" href="/">
                                {/* <i className="fab fa-twitter text-twitter"></i> */}
